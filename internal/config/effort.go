...
func EffortCapabilityForEntry(e *ProviderEntry) EffortCapability {
	...
	case e != nil && strings.EqualFold(strings.TrimSpace(e.Kind), "gemini"):
		return geminiEffortCapability()
	default:
		return EffortCapability{}
	}
}
...
func NormalizeEffort(e *ProviderEntry, raw string) (string, error) {
	...
	case e != nil && strings.EqualFold(strings.TrimSpace(e.Kind), "gemini"):
		switch level {
		case "low", "medium", "high", "max", "disabled":
			return level, nil
		case "off", "none":
			return "disabled", nil
		case "xhigh":
...
func geminiEffortCapability() EffortCapability {
