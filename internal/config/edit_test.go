...
func TestRemoveProviderClearsVisionModel(t *testing.T) {
	c := Default()
	c.DefaultModel = "primary"
	c.Agent.VisionModel = "vision"
	c.Providers = []ProviderEntry{
		{Name: "primary", Kind: "openai", BaseURL: "https://primary.invalid/v1", Model: "text"},
		{Name: "vision", Kind: "openai", BaseURL: "https://vision.invalid/v1", Model: "vl", VisionModels: []string{"vl"}},
	}
