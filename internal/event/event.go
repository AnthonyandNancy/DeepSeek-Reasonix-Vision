...
const (
	...
	StreamAttempt
	// VisionProgress replaces one visual-model status record as the request advances.
	VisionProgress
...
const (
	...
	VisionStageWaiting    VisionProgressStage = "waiting"
	VisionStageResponse   VisionProgressStage = "response"
	VisionStageThinking   VisionProgressStage = "thinking"
	VisionStageParsing    VisionProgressStage = "parsing"
...
type Event struct {
	...
	VisionProgress  *VisionProgressInfo
}
