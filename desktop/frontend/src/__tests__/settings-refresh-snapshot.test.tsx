...
eq(providerChatURLPreview("https://generativelanguage.googleapis.com/v1beta", "", false, "gemini"), "https://generativelanguage.googleapis.com/v1beta/models/{model}:generateContent", "Gemini preview uses the GenerateContent endpoint");
...
eq(providerBaseURLFromChatURL("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent"), "https://generativelanguage.googleapis.com/v1beta", "Gemini URL derives base URL for model discovery");
