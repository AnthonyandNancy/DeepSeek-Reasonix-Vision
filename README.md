...
- **ModLens v2 visual-evidence fallback (this fork).** Text-only main models can
  use `[agent].vision_model` to turn user/tool images into validated OCR/layout/
  semantic/uncertainty evidence before inference, while native multimodal models
  keep the direct-image path. See [`docs/VISUAL_EVIDENCE.md`](docs/VISUAL_EVIDENCE.md)
  and [`MERGE_NOTES.md`](MERGE_NOTES.md).
